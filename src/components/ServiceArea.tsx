  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl h-[400px] border border-gray-200 relative group">
          <img 
          ...
          <div className="absolute bottom-8 right-8 bg-white p-4 rounded-lg shadow-xl flex items-center gap-4 border border-gray-100">
